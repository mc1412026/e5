 ...
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PUibute it and/or modify
 ...
 *
 * Set this value to 0 to fail on the first error to occur.#define MOTHERBOARD BOARD_BTT_OCTOPUS_MAX_EZ_V1_0
 */
