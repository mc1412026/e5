...
#define CUSTOM_MACHINE_NAME "Ender 5 Murcury one.1"
...
//#define SCARA
  ...
  // Shoulder and elbow angles when in home position. If left uns precisely.
  #define TPARA_LINKAGE_1 120     // (mm)
  #define TPARA_LINKAGE_2 120     // (mm)defined, cartesian home is used and
 ...
 * Inductive probes need space to keep from triggering early. #define
 *
 ...
 *     But: 'M851 W_POINT          -2 // (mm) Farthest distance below the trigger-point to go before stopping
...
//#define Z_MIN_PRZ+1' with a CLEARANCE of 2  =>  2mm from bed to nozzle.
 */
